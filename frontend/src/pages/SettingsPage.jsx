...
const SettingsPage = () => {
   ...
   const PREVIEW_MESSAGE = [
      ...
      {id: 2, content: "I'm doing well! Thanks for asking", isSent: true},
   ]
  return (
                     ...
                     <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                        <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                           <div className="flex items-center gap-3">
                              ...
                              <p className="text-xs text-base-70">Online</p>
                              </div>
                           </div>
                        </div>
                           ...
                           {PREVIEW_MESSAGE.map((message) => (
                              <div key={message.id} className={`flex ${message.isSent ? "justify-end" : "justify-start"}`}>
                                 <div className={`max-w-[80%] rounded-xl p-3 shadow-sm ${message.isSent ? "bg-primary text-primary-content" : "bg-base-200"}`}>
                                  ...
                                  <p className={`text-[10px] mt-1.5 ${message.isSent ? "text-primary-content/70" : "text-base-content/70"}`}>12:00PM</p>
                                 </div>
                              </div>
                           ))}
                        </div>
